...
const player1 : string[] = ["Ronaldo", "Messi", "Neymar"];
const player2 : string[] = ["Kaka", "Rivaldo", "Ronaldinho"];
...
const nationalPlayerList = {...nationalPlayer1, ...nationalPlayer2 }; // spread operator
